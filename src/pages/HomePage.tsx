      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px', paddingBottom: '100px' }}>
        ...
        >
          <motion.div variants={itemVariants} style={{
            width: '80px', height: '80px', backgroundColor: '#fff', color: '#000',
          ...
          <motion.h1 variants={itemVariants} style={{
            ...
            WORDLE<br/>
            <span style={{ color: '#22c55e' }}>ENTROPY</span>
          </motion.h1>
          
          <motion.h2 variants={itemVariants} style={{
            fontFamily: '"Roboto Condensed", sans-serif', fontSize: '24px', letterSpacing: '0.35em',
            marginTop: '16px', marginBottom: '24px', color: '#a3a3a3', textTransform: 'uppercase'
          }}>
            AUTONOMOUS SOLVER
          </motion.h2>
          ...
          <motion.p variants={itemVariants} style={{
            ...
            color: '#d4d4d4', lineHeight: '1.6', marginBottom: '40px'
          }}>
          ...
          <motion.div variants={itemVariants} style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', justifyContent: 'center' }}>
            <Link to="/download" style={{
              backgroundColor: '#22c55e', color: '#000', padding: '16px 32px',
              fontFamily: '"Bebas Neue", sans-serif', fontSize: '24px', textDecoration: 'none',
              borderRadius: '8px', letterSpacing: '0.05em', transition: 'background-color 0.2s'
            }}>
              DOWNLOAD EXTENSION
            </Link>
            <Link to="/install" style={{
              backgroundColor: 'transparent', color: '#fff', padding: '16px 32px',
              fontFamily: '"Bebas Neue", sans-serif', fontSize: '24px', textDecoration: 'none',
              borderRadius: '8px', border: '2px solid #2a2a2a', letterSpacing: '0.05em', transition: 'border-color 0.2s'
            }}>
              HOW IT WORKS
            </Link>
          </motion.div>
        ...
        >
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <div style={{ fontFamily: '"Roboto Condensed", sans-serif', color: '#22c55e', letterSpacing: '0.2em', marginBottom: '8px', textTransform: 'uppercase' }}>
              FEATURES
            </div>
          ...
          <div style={{
            ...
            {[
              ...
              <motion.div key={i} variants={itemVariants} style={{
                backgroundColor: '#161616', border: '1px solid #2a2a2a', borderRadius: '12px', padding: '24px',
                display: 'flex', flexDirection: 'column', alignItems: 'flex-start'
              }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: '16px' }}>
                  <path d={feature.icon}></path>
                </svg>
                <h3 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '24px', margin: '0 0 8px 0', letterSpacing: '0.05em' }}>
                  {feature.title}
                </h3>
                <p style={{ fontFamily: '"Inter", sans-serif', color: '#a3a3a3', margin: '0', fontSize: '15px', lineHeight: '1.5' }}>
                  {feature.desc}
                </p>
              </motion.div>
            ))}
        ...
        >
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '32px', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
            ...
            {/* Wordle Board Mock */}
            <div style={{ display: 'grid', gridTemplateRows: 'repeat(6, 1fr)', gap: '8px', padding: '16px', backgroundColor: '#161616', borderRadius: '12px', border: '1px solid #2a2a2a' }}>
                    ...
                    return (
                      <motion.div 
                        ...
                        style={{
                          ...
                          fontFamily: 'sans-serif', fontWeight: 'bold', color: '#fff',
            ...
            <motion.div variants={itemVariants} style={{
              ...
              <div>
                <div style={{ fontFamily: '"Roboto Condensed", sans-serif', color: '#a3a3a3', fontSize: '14px', textTransform: 'uppercase', marginBottom: '4px' }}>Best Guess</div>
                <div style={{ fontFamily: '"Anton", sans-serif', fontSize: '32px', color: '#fff' }}>CRANE</div>
              </div>
              <div style={{ width: '100%', height: '1px', backgroundColor: '#2a2a2a' }} />
              <div>
                <div style={{ fontFamily: '"Roboto Condensed", sans-serif', color: '#a3a3a3', fontSize: '14px', textTransform: 'uppercase', marginBottom: '4px' }}>Entropy</div>
                <div style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '24px', color: '#f59e0b', letterSpacing: '0.05em' }}>5.74 BITS</div>
              </div>
              <div>
                <div style={{ fontFamily: '"Roboto Condensed", sans-serif', color: '#a3a3a3', fontSize: '14px', textTransform: 'uppercase', marginBottom: '4px' }}>Words Left</div>
                <div style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '24px', color: '#fff', letterSpacing: '0.05em' }}>2309</div>
              </div>
            </motion.div>
        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px' }}>
            <motion.div variants={itemVariants} style={{
              backgroundColor: '#161616', border: '1px solid #2a2a2a', borderRadius: '12px', padding: '32px',
              textAlign: 'center'
            }}>
              <h3 style={{ fontFamily: '"Bebas Neue", sans-serif', fontSize: '32px', margin: '0 0 8px 0', letterSpacing: '0.05em' }}>NEW YORK TIMES WORDLE</h3>
              <a href="https://www.nytimes.com/games/wordle/index.html" target="_blank" rel="noreferrer" style={{ color: '#a3a3a3', fontSize: '14px', fontFamily: '"Inter", sans-serif', textDecoration: 'underline', display: 'block', marginBottom: '16px' }}>nytimes.com/games/wordle</a>
              <p style={{ fontFamily: '"Inter", sans-serif', color: '#d4d4d4', margin: '0', lineHeight: '1.6' }}>
            ...
            <motion.div variants={itemVariants} style={{
              ...
              <a href="https://wordle.name/" target="_blank" rel="noreferrer" style={{ color: '#a3a3a3', fontSize: '14px', fontFamily: '"Inter", sans-serif', textDecoration: 'underline', display: 'block', marginBottom: '16px' }}>wordle.name</a>
              <p style={{ fontFamily: '"Inter", sans-serif', color: '#d4d4d4', margin: '0', lineHeight: '1.6' }}>
        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '24px', marginBottom: '48px', textAlign: 'left' }}>
            {[
              ...
              <motion.div key={i} variants={itemVariants} style={{
                position: 'relative', padding: '24px', border: '1px solid #2a2a2a', borderRadius: '12px', backgroundColor: '#161616'
              }}>
                <div style={{ fontFamily: '"Anton", sans-serif', fontSize: '64px', color: '#2a2a2a', position: 'absolute', top: '10px', right: '20px', lineHeight: '1' }}>
                  {step.num}
                </div>
                ...
                <p style={{ fontFamily: '"Inter", sans-serif', color: '#a3a3a3', margin: '0', fontSize: '15px', lineHeight: '1.5', position: 'relative', zIndex: 1 }}>
                  {step.desc}
                </p>
              </motion.div>
            ))}
          ...
          <motion.div variants={itemVariants}>
            <Link to="/install" style={{
              display: 'inline-block', backgroundColor: 'transparent', color: '#fff', padding: '16px 32px',
              fontFamily: '"Bebas Neue", sans-serif', fontSize: '24px', textDecoration: 'none',
              borderRadius: '8px', border: '2px solid #22c55e', letterSpacing: '0.05em', transition: 'all 0.2s'
            }}>
